...
function scopeExample(){
    let localVariable = "This is a localVariable inside of the scopeExample() function";
...
// let's create a number variable and initialize it to a value of 5
 // can use number variable because other number variable was local
...
function calcChange(amount){
    //calculate the number of quarters and subtract from total change 
    let quarters = Math.floor(amount / 25);
    amount = amount - (quarters) * 25;
    //calculate the number of dimes and subtract from total change 
    let dimes = Math.floor(amount / 10);
    amount = amount - (dimes) * 10;
    //calculate the number of nickels and subtract from total change 
